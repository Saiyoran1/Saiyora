...
public:
	...
	virtual FAbilityEvent UseAbility(TSubclassOf<UCombatAbility> const AbilityClass) override;
...
private:
	...
	TMap<int32, FAbilityEvent> PredictedCastRecord;
	FAbilityEvent UsePlayerAbility(TSubclassOf<UPlayerCombatAbility> const AbilityClass, bool const bFromQueue = false);
