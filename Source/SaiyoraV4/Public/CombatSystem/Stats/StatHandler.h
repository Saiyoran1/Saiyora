...
public:
	...
	void AddStatModifiers(TMap<FGameplayTag, FCombatModifier> const& Modifiers, TMap<FGameplayTag, int32>& OutIDs);
	void RemoveStatModifiers(TMap<FGameplayTag, int32> const& ModifierIDs);
